    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-lg mx-auto bg-white p-2 rounded-full shadow-lg border border-slate-100 flex items-center mb-4 relative z-10">
          ...
          />
          <button className="bg-brand-500 hover:bg-brand-400 text-slate-900 font-bold py-3 px-8 rounded-full transition-colors whitespace-nowrap shadow-md">
            Try for Free
          </button>
        </div>
            ...
            <div className="bg-slate-50 rounded-[2rem] overflow-hidden min-h-[400px] md:min-h-[700px] flex flex-col md:flex-row relative">
              ...
              <div className="hidden md:flex w-20 bg-white border-r border-slate-100 flex-col items-center py-8 gap-6 z-10">
                 ...
                 <div className="flex flex-col gap-5 w-full px-4 items-center">
                    <button className="w-10 h-10 rounded-xl flex items-center justify-center text-slate-400 hover:bg-slate-50 hover:text-slate-900 transition-colors">
                        <Home className="w-5 h-5" />
                    </button>
                    <button className="w-10 h-10 rounded-xl flex items-center justify-center bg-black text-white shadow-lg">
              ...
              <div className="flex-1 p-6 md:p-10 overflow-hidden flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <div className="bg-black text-white p-7 rounded-[2rem] relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div className="text-xs text-slate-400 font-medium">Payout • $6.1K will available soon</div>
                  </div>
                  ...
                  <div className="bg-white p-7 rounded-[2rem] shadow-sm border border-slate-100 hover:scale-[1.02] transition-transform duration-300">
                    <div className="flex items-center justify-between mb-10">
                      ...
                      <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-400 flex items-center justify-center group-hover:bg-slate-200 transition-colors">
                        <ArrowRight className="w-3 h-3 -rotate-45" strokeWidth={3} />
                      </div>
                    </div>
                  ...
                  <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 min-h-[240px] flex flex-col justify-between">
                     <div className="flex justify-between items-start mb-6">
                       <div>
                         ...
                         <p className="text-xs text-slate-400 mt-1">Total view per month</p>
                       </div>
                     ...
                     <div className="flex items-end gap-4 h-32 px-2">
                       ...
                       <div className="flex-1 h-[100%] bg-brand-500 rounded-t-xl relative group shadow-lg shadow-brand-200">
                          <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-black text-white text-[10px] py-1.5 px-3 rounded-lg opacity-100 font-bold shadow-xl">
                            243K
                          </div>
                       </div>
                  ...
                  <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 min-h-[240px] flex flex-col justify-between">
                     <div className="flex justify-between items-start mb-6">
                       <div>
                         ...
                         <p className="text-xs text-slate-400 mt-1">Based on social media</p>
                       </div>
                     ...
                     <div className="space-y-4">
                       ...
                       <div className="flex items-center gap-6">
                           <span className="text-xs font-bold text-slate-400 w-16">Facebook</span>
                           <div className="flex-1 grid grid-cols-4 gap-2">
                               <div className="h-8 rounded-xl bg-slate-100"></div>
                               <div className="h-8 rounded-xl bg-slate-100"></div>
                               <div className="h-8 rounded-xl bg-brand-400"></div>
                               <div className="h-8 rounded-xl bg-slate-100"></div>
                           </div>
                       </div>
                       ...
                       {/* Instagram Row */}
                       <div className="flex items-center gap-6">
                           <span className="text-xs font-bold text-slate-400 w-16">Instagram</span>
                           <div className="flex-1 grid grid-cols-4 gap-2">
                               <div className="h-8 rounded-xl bg-slate-100"></div>
                               <div className="h-8 rounded-xl bg-brand-400"></div>
                               <div className="h-8 rounded-xl bg-black"></div>
                               <div className="h-8 rounded-xl bg-black"></div>
                           </div>
                       </div>
                       ...
                       {/* Tiktok Row */}
                       <div className="flex items-center gap-6">
                           <span className="text-xs font-bold text-slate-400 w-16">Tiktok</span>
                           <div className="flex-1 grid grid-cols-4 gap-2">
                               <div className="h-8 rounded-xl bg-brand-400"></div>
                               <div className="h-8 rounded-xl bg-brand-400"></div>
                               <div className="h-8 rounded-xl bg-slate-100"></div>
