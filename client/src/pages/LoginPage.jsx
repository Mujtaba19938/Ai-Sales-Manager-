...
import { Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Sun } from 'lucide-react';
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <h1 style={{
                        ...
                        Smart analytics for{' '}
                        <span style={{ color: '#22c55e' }}>growing businesses</span>
                    </h1>
                    <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, maxWidth: 440 }}>
                        Track revenue, manage expenses, and unlock AI-powered insights to maximize your profitability.
                    </p>

                    {/* Feature pills */}
                    <div style={{ display: 'flex', gap: 10, marginTop: 40, flexWrap: 'wrap' }}>
                        {['Real-time Dashboard', 'AI Chat Assistant', 'Profit Analytics'].map(f => (
                            <span key={f} style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ textAlign: 'center', marginTop: 28, fontSize: 14, color: '#64748b' }}>
                        ...
                        <Link to="/signup" style={{ color: '#22c55e', textDecoration: 'none', fontWeight: 700 }}>
                            Create one
                        </Link>
                    </p>
                </div>
